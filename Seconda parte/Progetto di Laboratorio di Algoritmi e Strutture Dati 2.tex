...
\lstinputlisting[language=Python,linerange={1-56}]{bst.py} 
...
\subsection{Implementazione della struttura dati}  
\lstinputlisting[language=Python,linerange={1-79}]{avl.py} 
...
\subsection{Implementazione della struttura dati}  
\lstinputlisting[language=Python,linerange={1-158}]{rbt.py} 

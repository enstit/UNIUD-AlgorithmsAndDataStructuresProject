...
\lstinputlisting[language=Python,firstline=1,lastline=16]{sources/PeriodNaive.py} 
...
\lstinputlisting[language=Python,firstline=20,lastline=27]{sources/PeriodNaive.py} 
...
\lstinputlisting[language=Python,firstline=40,lastline=46]{sources/Complexity.py}
...
\lstinputlisting[language=Python,firstline=49,lastline=65]{sources/Complexity.py}
...
\begin{axis}[
    ...
    axis line style={->},
    xlabel={\small Dimensione dell'input (\textit{caratteri})},
...
Per poter apprezzare meglio le misurazioni, è possibile visualizzare il grafico con scala logaritmica su entrambi gli assi.

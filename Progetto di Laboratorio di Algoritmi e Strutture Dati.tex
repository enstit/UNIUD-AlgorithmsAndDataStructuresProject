...
\end{gather*}
\lstinputlisting[language=Python,firstline=24,lastline=27]{sources/Complexity.py}
\lstinputlisting[language=Python,firstline=10,lastline=18]{sources/InputGenerator.py}
...
\lstinputlisting[language=Python,firstline=3,lastline=8]{sources/InputGenerator.py}
\lstinputlisting[language=Python,firstline=37,lastline=46]{sources/InputGenerator.py}
...
\lstinputlisting[language=Python,firstline=34,lastline=62]{sources/Complexity.py}
...
Un esempi di stringa formata in questo modo è:
\begin{equation*}
